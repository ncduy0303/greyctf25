...
import SecurePickle, string, random, time
...
"""
    ...
    def easyLogin(self):
        try:
            user = SecurePickle.loads(b64decode(input("Enter EasyCreds: ")))
            ...
            raise Exception(f"EasyCreds feature is under maintenance")
...
[E] Print EasyCreds'''
    ...
    def easyCreds(self):
        return b64encode(SecurePickle.dumps(self.currUser)).decode()
